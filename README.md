...
5. 浏览器多用户窗口需要绑定Profile；快捷方式添加目标: "C:\Program Files\Google\Chrome\Application\chrome.exe" --profile-directory="Profile XX" --user-data-dir="D:\Users\laozi\AppData\Local\Google\Chrome\User Data\XXXX"
## 构建
